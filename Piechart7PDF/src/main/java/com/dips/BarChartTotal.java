...
//		theTickUnits.add( new NumberTickUnit(200));
//		theTickUnits.add( new NumberTickUnit(7000));
//		xAxis.setStandardTickUnits( theTickUnits );
		
//		if(scaleSize != null) {
//			xAxis.setLowerMargin(0.0);
//			xAxis.setUpperMargin(0.0);
//			xAxis.setAutoRange(false);
//			xAxis.setLowerBound(700.0);
//			xAxis.setUpperBound(7000.0);
//			xAxis.setAutoTickUnitSelection(false);
//			xAxis.setTickUnit(new NumberTickUnit(scaleSize));
//			xAxis.setRange(200, 7000);
//			xAxis.setTickUnit(new NumberTickUnit(scaleSize.doubleValue()));
//		}
...
//		plot.setRangeAxis(xAxis);	//set range of x-axis
	 ...
	 //Now add your markers
	  Double benchmarkValue = 11673.0;
	  ValueMarker vm = new ValueMarker(benchmarkValue); //200 is the position you like it to be
	  vm.setPaint(Color.BLACK);
	  vm.setStroke(new BasicStroke(3));
	  vm.setLabel(benchmarkValue.toString()); //The label
	  vm.setLabelAnchor(RectangleAnchor.CENTER);
	  vm.setLabelTextAnchor(TextAnchor.CENTER_RIGHT);
	  plot.addRangeMarker(vm);
	  plot.getRangeAxis().setUpperBound(benchmarkValue+benchmarkValue*0.05);
	  System.out.println(plot.getRangeAxis().getUpperBound());
//	  plot.getRangeAxis().setUpperBound(14000);
